class Solution {
    public int jobScheduling(int[] startTime, int[] endTime, int[] profit) {
        ...
        // Sort all the jobs based on endTime
        Collections.sort(list, (a,b)-> a.getEndTime() - b.getEndTime());
        
        // Map<Key = EndTime, Value = MaxProfitTillEndTime>
        TreeMap<Integer, Integer> map = new TreeMap<Integer, Integer>();
        // Profit till a particular job endTime = maxProfit till current job startTime + current job profit;
        int maxProfit = 0;
        for(Job job : list){
